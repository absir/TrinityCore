...
public:
       ...
       /*else */if (spellInfo->GetAllEffectsMechanicMask() & (1<<MECHANIC_SNARE) ||
        ...
        bool BuffTarget(Unit* target, uint32 diff)
        {
            ...
            if (target->GetTypeId() == TYPEID_PLAYER)
				...
				Class = AB_GetBotAI(cre) ? AB_GetBotAI(cre)->GetPlayerClass() : cre->getClass();
 ...
 /*SPECIAL*/InitSpellMap(ARDENT_DEFENDER_HEAL, true);
        ...
        void ApplyClassPassives()
        {
			...
			RefreshAura(PALADIN_PURE, level >= 55 ? 1 : 0);
    ...
    private:
        ...
        //Talents
            ...
            PALADIN_PURE/*Judgements of the Pure*/      = 54155,
