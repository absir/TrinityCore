...
#ifndef IS_PLAYER_GUID
#define IS_PLAYER_GUID(guid) (guid.GetHigh() == HIGHGUID_PLAYER) 
#define MAKE_NEW_GUID(l, e ,h) (ObjectGuid)(uint64(uint64(l) | (uint64(e) << 24) | (uint64(h) << 48)))
#endif

#ifndef MAX_ITEM_SPELLS
